-- Nuova voce nell'elenco Documenti: "Piano Compensi e Posizioni Aziendali",
-- come riga separata invece di riusare lo slot "Presentazione Attività"
-- (richiesta esplicita dell'utente dopo la prima scelta).
insert into marketing_documents (doc_type)
values ('piano_compensi')
...
begin
  ...
  if p_doc_type not in ('privacy', 'modulo_ordine', 'contratto_incaricato', 'presentazione', 'flyer', 'business_card', 'piano_compensi') then
