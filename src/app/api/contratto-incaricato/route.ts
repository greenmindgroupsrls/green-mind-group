...
export async function POST(request: Request) {
  ...
  const data: ContractData = {
    ...
    declUnemployed: yes("decl_unemployed"),
    declSocialSecurity: yes("decl_social_security"),
    declPensioner: yes("decl_pensioner"),
...
export async function GET() {
  ...
  const data: ContractData = {
    ...
    declUnemployed: contract.decl_unemployed,
    declSocialSecurity: contract.decl_social_security,
    declPensioner: contract.decl_pensioner,
