...
export async function POST(request: Request) {
  ...
  const data: ContractData = {
    ...
    iban: t("iban"),
    swift: t("swift"),
    declOtherCompanies: yes("decl_other_companies"),
    declHasVat: yes("decl_has_vat"),
    declInpsExceeded: yes("decl_inps_exceeded"),
...
export async function GET() {
  ...
  const data: ContractData = {
    ...
    declOtherCompanies: contract.decl_other_companies,
    declHasVat: contract.decl_has_vat,
    declInpsExceeded: contract.decl_inps_exceeded,
