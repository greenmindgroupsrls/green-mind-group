...
export default async function PayoutOverviewPage() {
  ...
  const rows = [
    { abbr: "AT", label: T.acquistiTotali, value: totalPurchases, dot: "bg-orange-500", color: "#f97316" },
    { abbr: "GT", label: T.guadagniTotali, value: overview.totalEarnings, dot: "bg-accent", color: "var(--accent)" },
    { abbr: "PT", label: T.prelieviTotali, value: totalPayouts, dot: "bg-blue-500", color: "#3b82f6" },
    { abbr: "TO", label: T.tasseOneri, value: taxAndCharges, dot: "bg-rose-500", color: "#f43f5e" },
    { abbr: "UN", label: T.utileNetto, value: netBenefits, dot: "bg-amber-500", color: "#f59e0b" },
  ];

  const categoryBreakdown = [
    { label: TP.diretta, value: overview.byLevel[0] },
    { label: TP.livello.replaceAll("{n}", "1"), value: overview.byLevel[1] },
    { label: TP.livello.replaceAll("{n}", "2"), value: overview.byLevel[2] },
    { label: TP.livello.replaceAll("{n}", "3"), value: overview.byLevel[3] },
  ];
        ...
        <div className="glass-card">
          ...
          <div className="p-6 flex flex-col gap-5">
            ...
            <div className="flex flex-col divide-y divide-gray-100 dark:divide-white/5">
              {[
                { label: T.guadagniTotali, value: overview.totalEarnings },
                { label: T.totaleAddebiti, value: totalPayouts },
                { label: T.prelieviInSospeso, value: pendingWithdrawals },
                { label: T.prelieviCompletati, value: paidWithdrawals },
              ].map((r) => (
