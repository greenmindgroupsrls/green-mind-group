...
export function GoogleButton({
  ...
  async function handleClick() {
    ...
    if (refCode !== undefined) {
      callbackUrl.searchParams.set("ref", String(refCode));
      if (refUsername) callbackUrl.searchParams.set("refName", refUsername);
    }
    ...
    // in caso di successo il browser viene reindirizzato a Google, non serve altro
  }
